...
double metodaTrapezow(function<double(double)> f, double a, double b, int n) {
    double h = (b - a) / n;  
...
int main() {
    ...
    double przyblizona3 = metodaTrapezow(f3, a3, b3, n);
